...
def split_conv(input_tensor,
    ...
    **kwargs: will be passed directly into conv2d operator
    ...
    if num_ways == 1 or min(b//num_ways,
        ...
        # on either side.
        return mpusim_conv2d('{}conv'.format(scope), input_tensor, num_outputs, 1)
    ...
    for i, (input_tensor, out_size) in enumerate(zip(inputs, output_splits)):
        ...
        n = mpusim_conv2d('{}_conv'.format(scope), input_tensor, out_size, 1)
...
def squeeze_excite(input_tensor,
    ...
    with tf.compat.v1.variable_scope('squeeze_excite'):
        ...
        #squeeze = mpusim_conv2d('squeeze_excite_squeeze',
                                #pooled,
                                #squeeze_channels,
                                #[1, 1],
        ...
        #excite = mpusim_conv2d('squeeze_excite_excite',
                                #squeeze,
                                #excite_outputs,
                                #[1, 1],
                                #activation=gating_fn)
        
        excite = slim.conv2d(squeeze,
