...
class ImageNetModel(ModelDesc):
    ...
    def __init__(self, data_format='NCHW', wd=5e-5, learning_rate=0.1, data_aug=True, double_iter=False):
        if data_format == 'NCHW':
    ...
    def _get_optimizer(self):
        ...
        if not self.data_aug:
            ...
            lr = tf.train.polynomial_decay(self.lr, global_step, 640000 if self.double_iter else 320000, 1e-5, power=1.)
